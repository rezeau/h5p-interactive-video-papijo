 ...
 */
function InteractiveVideoPapiJo(params, id, contentData) {
  var self = this;
  var startAt;
  var loopVideo;
  ...
  self.initialize = function () {
    ...
    self.video.on('stateChange', function (event) {
      ...
      if (self.currentState === InteractiveVideoPapiJo.SEEKING) {
...
// Inheritance
InteractiveVideoPapiJo.prototype = Object.create(H5P.EventDispatcher.prototype);
InteractiveVideoPapiJo.prototype.constructor = InteractiveVideoPapiJo;
 ...
 */
InteractiveVideoPapiJo.prototype.setCaptionTracks = function (tracks) {
  var self = this;
 ...
 */
InteractiveVideoPapiJo.prototype.getCurrentState = function () {
  var self = this;
 ...
 */
InteractiveVideoPapiJo.prototype.removeSplash = function () {
 ...
 */
InteractiveVideoPapiJo.prototype.attach = function ($container) {
  var that = this;
  ...
  if (!this.video.pressToPlay) {
    if (this.currentState === InteractiveVideoPapiJo.LOADED) {
      // Add all controls
      this.addControls();
    }
    else {
  ...
  this.currentState = InteractiveVideoPapiJo.ATTACHED;
};
 ...
 */
InteractiveVideoPapiJo.prototype.attachVideo = function ($wrapper) {
 ...
 * Add splash screen
 */
InteractiveVideoPapiJo.prototype.addSplash = function () {
  var that = this;
 ...
 */
InteractiveVideoPapiJo.prototype.getDuration = function () {
 ...
 */
InteractiveVideoPapiJo.prototype.addControls = function () {
  const self = this;
  ...
  const humanTime = InteractiveVideoPapiJo.humanizeTime(duration);
  const a11yTime = InteractiveVideoPapiJo.formatTimeForA11y(duration, self.l10n);
    ...
    for (let i = this.options.assets.endscreens.length-1; i>=0; i--) {
      ...
      if (endscreen.time > endTime) {
        if (!haveEndscreenMovedToEnd) {
          ...
          this.options.assets.endscreens[i].label = InteractiveVideoPapiJo.humanizeTime(endTime) + ' ' + this.l10n.endscreen;
 ...
 */
InteractiveVideoPapiJo.prototype.loaded = function () {
  // Get duration
  ...
  if (this.currentState === InteractiveVideoPapiJo.ATTACHED) {
    if (!this.video.pressToPlay) {
      this.addControls();
    }
  ...
  this.currentState = InteractiveVideoPapiJo.LOADED;
};
 ...
 */
InteractiveVideoPapiJo.prototype.initInteraction = function (index) {
  var self = this;
 ...
 */
InteractiveVideoPapiJo.prototype.handleAnswered = function () {
  const self = this;
 ...
 */
InteractiveVideoPapiJo.prototype.getAnsweredTotal = function () {
 ...
 *   false otherwise
 */
InteractiveVideoPapiJo.prototype.hasMainSummary = function () {
 ...
 */
InteractiveVideoPapiJo.prototype.addSliderInteractions = function () {
  const self = this;
  // Remove old dots
 ...
 */
InteractiveVideoPapiJo.prototype.handleInteractionTabIndex = function (event) {
 ...
 */
InteractiveVideoPapiJo.prototype.closePopupMenus = function ($exceptButton) {
 ...
 * @return {boolean}
 */
InteractiveVideoPapiJo.prototype.displayBookmarks = function () {
 ...
 */
InteractiveVideoPapiJo.prototype.addBookmarks = function () {
  this.bookmarksMap = {};
 ...
 * Puts all the cool narrow lines around the slider / seek bar.
 */
InteractiveVideoPapiJo.prototype.addEndscreenMarkers = function () {
  this.endscreensMap = {};
 ...
 */
InteractiveVideoPapiJo.prototype.addBubbles = function () {
 ...
 */
InteractiveVideoPapiJo.prototype.toggleBookmarksChooser = function (show, params = {initialLoad: false, keepStopped: false, firstPlay: false}) {
 ...
 * @param {boolean} [params.firstPlay] If first time.
 */
InteractiveVideoPapiJo.prototype.toggleEndscreensChooser = function (show, params = {keepStopped: false, firstPlay: false}) {
 ...
 */
InteractiveVideoPapiJo.prototype.updateChooserTime = function ($chooser, selector) {
  const $addElement = $chooser.find(selector);
  $addElement.html($addElement.data('default').replace('@timecode', InteractiveVideoPapiJo.humanizeTime(this.video.getCurrentTime())));
};

/**
 * Will interrupt the video and remember that is was interrupted for resuming later.
 */
InteractiveVideoPapiJo.prototype.interruptVideo = function () {
 ...
 */
InteractiveVideoPapiJo.prototype.resumeVideo = function (override) {
  if (!override) {
 ...
 */
InteractiveVideoPapiJo.prototype.toggleEndscreen = function (show) {
 ...
 */
InteractiveVideoPapiJo.prototype.showPreventSkippingMessage = function (offset = {}, message) {
  var self = this;
 ...
 */
InteractiveVideoPapiJo.prototype.onBookmarkSelect = function ($bookmark, bookmark) {
  const self = this;
  ...
  const l11yTime = InteractiveVideoPapiJo.formatTimeForA11y(bookmark.time, self.l10n);
 ...
 */
InteractiveVideoPapiJo.prototype.onEndscreenSelect = function ($endscreenMarker, endscreen) {
  const self = this;
  ...
  const l11yTime = InteractiveVideoPapiJo.formatTimeForA11y(endscreen.time, self.l10n);
  setTimeout(() => self.read(`${self.l10n.currentTime} ${l11yTime}`), 150);
};
 ...
 * @returns {H5P.jQuery}
 */
InteractiveVideoPapiJo.prototype.addBookmark = function (id, tenth) {
  var self = this;
 ...
 * @returns {H5P.jQuery}
 */
InteractiveVideoPapiJo.prototype.addEndscreen = function (id, tenth) {
  var self = this;
 ...
 * @param {H5P.jQuery} $wrapper
 */
InteractiveVideoPapiJo.prototype.attachControls = function ($wrapper) {
  var self = this;
  ...
  const textFullTime = InteractiveVideoPapiJo.formatTimeForA11y(0, self.l10n);
  ...
  self.controls.$slider = $('<div/>', {appendTo: self.$sliderContainer}).slider({
    ...
    create: function (event) {
      ...
      $handle
        ...
        .attr('aria-valuetext', InteractiveVideoPapiJo.formatTimeForA11y(0, self.l10n))
    ...
    start: function () {
      ...
      self.currentState = InteractiveVideoPapiJo.SEEKING;
 ...
 */
InteractiveVideoPapiJo.prototype.playStarAnimation = function () {
  const self = this;
 ...
 */
InteractiveVideoPapiJo.prototype.playBubbleAnimation = function (text) {
 ...
 */
InteractiveVideoPapiJo.prototype.hasActivePauseInteraction = function () {
 ...
 */
InteractiveVideoPapiJo.prototype.createButton = function (type, extraClass, $target, handler, text) {
  var self = this;
  var options = {
    role: 'button',
    tabindex: 0,
 ...
 */
InteractiveVideoPapiJo.prototype.addQualityChooser = function () {
  var self = this;
 ...
 */
InteractiveVideoPapiJo.prototype.updateQuality = function (quality) {
  var self = this;
 ...
 */
InteractiveVideoPapiJo.prototype.addPlaybackRateChooser = function () {
  var self = this;
...
InteractiveVideoPapiJo.prototype.updatePlaybackRate = function (rate) {
  var self = this;
 ...
 */
InteractiveVideoPapiJo.prototype.startUpdatingBufferBar = function () {
  var self = this;
  if (self.bufferLoop) {
    return;
  }
 ...
 */
InteractiveVideoPapiJo.prototype.resize = function () {
  // Not yet attached
  if (!this.$container) {
    return;
  }
 ...
 */
InteractiveVideoPapiJo.prototype.resizeMobileView = function () {
  // IV not init
 ...
 */
InteractiveVideoPapiJo.prototype.resizeInteractions = function () {
  // IV not init
  if (isNaN(this.currentState)) {
    return;
  }
 ...
 */
InteractiveVideoPapiJo.prototype.recreateCurrentInteractions = function () {
 ...
 */
InteractiveVideoPapiJo.prototype.resizeStartScreen = function () {
 ...
 */
InteractiveVideoPapiJo.prototype.toggleFullScreen = function () {
  var self = this;
 ...
 */
InteractiveVideoPapiJo.prototype.timeUpdate = function (time, skipNextTimeUpdate) {
  var self = this;
 ...
 */
InteractiveVideoPapiJo.prototype.setSliderPosition = function (time) {
  try {
    const sliderHandle = this.controls.$slider.find('.ui-slider-handle');
    const timePassedText = InteractiveVideoPapiJo.formatTimeForA11y(time, this.l10n);
 ...
 * @param {number} time
 */
InteractiveVideoPapiJo.prototype.updateInteractions = function (time) {
  var self = this;
  ...
  if (tenth !== self.lastTenth) {
    ...
    const regularEndscreenHit = function () {
      return self.endscreensMap !== undefined && self.endscreensMap[tenth] !== undefined && self.currentState !== InteractiveVideoPapiJo.SEEKING;
    };
 ...
 */
InteractiveVideoPapiJo.prototype.updateCurrentTime = function (seconds) {
  var self = this;

  seconds = Math.max(seconds, 0);

  const humanTime = InteractiveVideoPapiJo.humanizeTime(seconds);
  const a11yTime = InteractiveVideoPapiJo.formatTimeForA11y(seconds, self.l10n);
 ...
 * @returns {number}
 */
InteractiveVideoPapiJo.prototype.getUsersScore = function () {
  var score = 0;
 ...
 * @returns {number}
 */
InteractiveVideoPapiJo.prototype.getUsersMaxScore = function () {
  var maxScore = 0;
 ...
 * @returns {number}
 */
InteractiveVideoPapiJo.prototype.getScore = function () {
 ...
 * @returns {number}
 */
InteractiveVideoPapiJo.prototype.getMaxScore = function () {
 ...
 */
InteractiveVideoPapiJo.prototype.showOverlayMask = function () {
  var self = this;
 ...
 */
InteractiveVideoPapiJo.prototype.restorePosterTabIndexes = function () {
  const self = this;
 ...
 */
InteractiveVideoPapiJo.prototype.disableTabIndexes = function (elementToExclude = '.h5p-dialog-wrapper') {
  var self = this;
 ...
 */
InteractiveVideoPapiJo.prototype.restoreTabIndexes = function ($withinContainer) {
  var self = this;
 ...
 * within them.
 */
InteractiveVideoPapiJo.prototype.toggleFocusTrap = function () {
 ...
 */
InteractiveVideoPapiJo.prototype.trapFocusInInteractions = function (requiredInteractions, $focusedElement) {
 ...
 * @return {jQuery} the dialog wrapper element
 */
InteractiveVideoPapiJo.prototype.hideOverlayMask = function () {
  var self = this;
 ...
 * @returns {jQuery}
 */
InteractiveVideoPapiJo.prototype.showWarningMask = function () {
  const self = this;
 ...
 * @return {jQuery}
 */
InteractiveVideoPapiJo.prototype.setDisabled = $element => {
  return $element
 ...
 * @return {boolean}
 */
InteractiveVideoPapiJo.prototype.isDisabled = $element => {
 ...
 * @return {jQuery}
 */
InteractiveVideoPapiJo.prototype.removeDisabled = $element => {
  return $element
 ...
 */
InteractiveVideoPapiJo.prototype.hasUncompletedRequiredInteractions = function (second) {
  var self = this;
 ...
 */
InteractiveVideoPapiJo.prototype.getVisibleInteractions = function () {
 ...
 * @return {H5P.InteractiveVideoInteraction[]} visible interactions
 */
InteractiveVideoPapiJo.prototype.getVisibleInteractionsAt = function (second) {
  return this.interactions.filter(function (interaction) {
 ...
 */
InteractiveVideoPapiJo.prototype.showSolutions = function () {
 ...
 * @returns {string}
 */
InteractiveVideoPapiJo.prototype.getTitle = function () {
 ...
 */
InteractiveVideoPapiJo.prototype.findNextInteractionToShow = function (time, index) {
  let candidate;
  for (var i = 0; i < this.interactions.length; i++) {
 ...
 */
InteractiveVideoPapiJo.prototype.findNextInteractionToHide = function (time) {
  let candidate;
 ...
 * @param {number} time
 */
InteractiveVideoPapiJo.prototype.hideInteractions = function (time) {
 ...
 * @param {number} time
 */
InteractiveVideoPapiJo.prototype.showInteractions = function (time) {
 ...
 * @param {number} time
 */
InteractiveVideoPapiJo.prototype.toggleInteractions = function (time) {
 ...
 */
InteractiveVideoPapiJo.prototype.play = function () {
  this.video.play();
};
 ...
 */
InteractiveVideoPapiJo.prototype.seek = function (time = 0, options = {}) {
 ...
 */
InteractiveVideoPapiJo.prototype.pause = function () {
 ...
 */
InteractiveVideoPapiJo.prototype.resetTask = function () {
 ...
 */
InteractiveVideoPapiJo.prototype.read = function (content) {
  const self = this;
 ...
 */
InteractiveVideoPapiJo.prototype.getCopyrights = function () {
  var self = this;
 ...
 */
InteractiveVideoPapiJo.prototype.isSkippingProhibited = function (time = 0) {
  if (this.editor) {
    return false;
  }
...
/** @constant {number} */
InteractiveVideoPapiJo.SEEKING = 4;
/** @constant {number} */
InteractiveVideoPapiJo.LOADED = 5;
/** @constant {number} */
InteractiveVideoPapiJo.ATTACHED = 6;
 ...
 * @returns {string}
 */
InteractiveVideoPapiJo.humanizeTime = function (seconds) {
  const time = InteractiveVideoPapiJo.secondsToMinutesAndHours(seconds);
  let result = '';
 ...
 * @return {string}
 */
InteractiveVideoPapiJo.formatTimeForA11y = function (seconds, labels) {
  const time = InteractiveVideoPapiJo.secondsToMinutesAndHours(seconds);
 ...
 * @return {Time}
 */
InteractiveVideoPapiJo.secondsToMinutesAndHours = function (seconds) {
 ...
 */
InteractiveVideoPapiJo.prototype.getXAPIData = function () {
  var self = this;
 ...
 */
 InteractiveVideoPapiJo.prototype.getContext = function () {
  var self = this;
...
export default InteractiveVideoPapiJo;
